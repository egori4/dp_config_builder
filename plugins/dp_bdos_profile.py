...
description:
  - Creates a BDOS Flood Protection profile on Radware DefensePro via Radware CC API.
options:
  provider:
    description:
  ...
  params:
    description:
      - Dictionary of BDOS profile attributes (rsNetFloodProfile*)
    type: dict
    required: true
author:
  - "Your Name"
...
def run_module():
  ...
  try:
    ...
    if not module.check_mode:
      ...
      logger.info(f"Creating BDOS Flood profile {module.params['name']} on device {module.params['dp_ip']}")

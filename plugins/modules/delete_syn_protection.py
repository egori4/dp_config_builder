...
options:
  ...
  protection_id:
    type: int
    required: false
    description: Numeric protection ID (overrides protection_name if provided)
author:
  - "Your Name"
'''
...
def run_module():
    ...
    protection_name = module.params.get('protection_name')
    ...
    try:
        ...
        if not module.check_mode:
            ...
            if protection_id:
                ...
                module.fail_json(msg="Either 'protection_name' or 'protection_id' must be provided")

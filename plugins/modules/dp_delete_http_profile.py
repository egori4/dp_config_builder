...
DOCUMENTATION = r'''
---
module: dp_delete_https_profile
short_description: Delete an HTTPS Flood profile on Radware DefensePro
options:
  provider:
    type: dict
    required: true
...
def run_module():
    ...
    try:
        ...
        if not module.check_mode:
            ...
            logger.info(f"Deleting HTTPS Flood profile {module.params['name']} on device {module.params['dp_ip']}")
            resp = cc._delete(url)

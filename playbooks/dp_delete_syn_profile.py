...
DOCUMENTATION = r'''
---
module: delete_ids_syn_attack
short_description: Delete an IDS SYN Attack profile from a DefensePro device
options:
  provider:
    type: dict
    required: true
...
def run_module():
    ...
    try:
        ...
        if not module.check_mode:
            ...
            logger.info(f"Deleting IDS SYN Attack profile {module.params['name']} on device {module.params['dp_ip']}")
